...
class RunDatabasesIdentifier:
    ...
    def get_historical_portfolio_value_db_identifier(
        ...
        """
        :return: the database identifier associated to
                this exchange's historical portfolio value
        :param exchange: name of the associated exchange
        :param portfolio_type_suffix: a suffix identifying
                the type of portfolio (future / sandbox etc)
        """
        return self._get_db_identifier(
